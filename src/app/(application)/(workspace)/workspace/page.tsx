            ...
            <div className='flex gap-10'>
                <div className='flex items-center justify-center md:justify-start'>
                    <Drawer>
                        <DrawerTrigger>
                            <div
                                className='py-8 px-10 md:w-[22rem] md:h-[10rem] border border-dashed rounded-lg flex justify-center items-center border-slate-800'
                            >
                ...
                <div className='flex-1 flex justify-start gap-7 flex-wrap'>
                    {userWorkspace.map(workspace => (
                        <div
                            ...
                            className={cn("p-4 px-5 w-full md:w-[22rem] md:h-[10rem] rounded-lg flex flex-col justify-between gap-2", workspace.backgroundColor ? `bg-[${workspace.backgroundColor}]` : `bg-[${defaultBg}]`)}
                        >
                            <div className='w-full flex flex-col gap-0.5'>
                                <div className='flex items-center justify-between p-0'>
                                    <h2 className='p-0 font-medium'>{workspace.title}</h2>
                                    <Button
                                        variant={"ghost"}
                            ...
                            <div className='flex flex-col justify-between h-full gap-2'>
                                <p className='text-xs truncate font-normal'>{workspace.description}</p>
                                <Link
                                    href={`/workspace/${workspace.id}`}
                                    className='w-full flex items-center border border-neutral-950 justify-between rounded p-2'
                                >
                                    <span>Enter</span>

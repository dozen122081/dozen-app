...
import WsAddCard from "./wsAddCard";
import WsCard from "./wsCard";
import WsDropIndicator from "./wsDropIndicator";
...
const WsColumn = ({
    ...
    const handleDragEnd = async (e: DragEvent | TouchEvent) => {
        ...
        if (before !== cardId) {
            ...
            setCards(copy);
            const response = await fetch('/api/workspace/todocat', {
                method: 'PUT',
                body: JSON.stringify({
                    newData: copy,
                    author: userId,
    ...
    return (
        <div className="w-56 shrink-0">
            ...
            >
                ...
                <WsDropIndicator beforeId={null} category={category} />
                <WsAddCard
                    column={category}
                    setCards={setCards}
                    userId={userId}

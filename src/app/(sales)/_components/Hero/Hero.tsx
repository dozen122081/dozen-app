...
const Hero = () => {
  ...
  return (
    <main className="flex h-[80vh] gap-10 flex-col items-center pt-10">
      <div className="flex flex-col justify-start gap-2 items-center w-full relative ">
        <div className="text-4xl font-light leading-[3rem] gap-7 flex flex-col items-center px-8    ">
          <h3 className="text-4xl flex gap-1">
            "Tired of Life's
            ...
            !"</h3>
          <h3 className="text-3xl">Dozen Organize Yourself and Your Team</h3>
        </div>
        <div className="text-2xl font-light px-8">
